...
#        app = QtGui.QApplication(sys.argv)
	...
	if self.checkfor(text2)==0:
        ...
        query = QtSql.QSqlQuery()
        query.prepare("insert into reg_table(name,credenzID,college) values(?,?,?)")
    ...
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(70, 120, 66, 31))
        ...
        self.label_3.setGeometry(QtCore.QRect(65, 234, 71, 31))
        ...
        self.label_4.setGeometry(QtCore.QRect(160, 40, 181, 51))
...
"color: rgb(62, 62, 62);"))
        ...
        self.submitButton.setGeometry(QtCore.QRect(230, 290, 61, 31))
